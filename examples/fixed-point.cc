...
int main() {
  ...
  fixedpoint::Value<8, 8> basic_number{100};
  ...
  assert( basic_number.AsI() == 117 );
  // The fractional part is 
  assert( basic_number.AsF() == 0xe0 );
  ...
  fixedpoint::Value<8, 8, false> unsigned_number = 40.4_u8_8;
