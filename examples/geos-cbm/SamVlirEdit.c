...
/* Through this pragma all functions and module data will be stored in VLIR 2 record. */

#pragma clang section text = ".vlir02.text" data = ".vlir02.data" bss = ".vlir02.bss"
