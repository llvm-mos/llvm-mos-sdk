...
/* return heap bytes available for future allocations.  Does not take into account
   the overhead of the heap itself, which depends on how many allocations are made.
*/
