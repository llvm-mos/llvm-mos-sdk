...
/* 20 */ extern __attribute__((leaf)) uint8_t
cpm_read_sequential_i(uint16_t fcb);
extern uint8_t cpm_read_sequential(FCB *fcb);
/* 21 */ extern __attribute__((leaf)) uint8_t
cpm_write_sequential_i(uint16_t fcb);
...
/* 27 */ extern __attribute__((leaf)) uint16_t
cpm_get_allocation_vector_i(void);
...
/* 30 */ extern __attribute__((leaf)) uint8_t
cpm_set_file_attributes_i(uint16_t fcb);
...
/* 37 */ extern __attribute__((leaf)) uint8_t
cpm_reset_drives(uint16_t drive_bitmap);
/* 40 */ extern __attribute__((leaf)) uint8_t
cpm_write_random_filled_i(uint16_t fcb);
...
/* 43 */ extern __attribute__((leaf)) uint16_t
cpm_parse_filename_i(uint16_t buffer);
...
extern __attribute__((leaf)) void
cpm_bios_setsec_i(uint16_t sector);            /* actually only 24 bits */
