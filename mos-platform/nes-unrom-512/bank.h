 ...
 */
#define UNROM_512_USE_2_SCREEN_HORIZONTAL \
 ...
 */
#define UNROM_512_USE_4_SCREEN_NAMETABLE \
	asm(".globl __mirroring\n.globl __four_screen\n__mirroring = 1\n__four_screen = 1\n")

#define UNROM_512_PRG_BANK_MASK       0x1F
#define UNROM_512_PRG_BANK_SHIFT      0
#define UNROM_512_CHR_BANK_MASK       0x60
#define UNROM_512_CHR_BANK_SHIFT      5
#define UNROM_512_CHR_BANK(n)	      ((n) << 5)
#define UNROM_512_CHR_BANK_0	      CHR_BANK(0)
#define UNROM_512_CHR_BANK_1	      CHR_BANK(1)
#define UNROM_512_CHR_BANK_2	      CHR_BANK(2)
#define UNROM_512_CHR_BANK_3	      CHR_BANK(3)
#define UNROM_512_MIRROR_SCREEN_MASK  0x80
#define UNROM_512_MIRROR_SCREEN_SHIFT 7
#define UNROM_512_MIRROR_SCREEN_1     0x00
#define UNROM_512_MIRROR_SCREEN_2     0x80

/**
 * @brief Get the value of the bank state.
 * 
 * @param mask The mask to get the value by.
 * @return The masked bank state value.
 */
__attribute__((leaf)) char get_bank_state(char mask);
 ...
 * @return The previous bank state value.
 */
 ...
 * This is only effective under @ref UNROM_512_USE_1_SCREEN
 * 
