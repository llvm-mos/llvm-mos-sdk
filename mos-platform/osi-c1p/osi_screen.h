...
template <unsigned int scr_base_uint = 0xD000, // start address of video RAM
          ...
          unsigned int screen_firstchar =
              0x85, // offset of cursor position (0, 0) from base of video RAM
          unsigned int scroll_dist =
              0x20 // memory distance for scrolling by one line
          >
class __osi_screen {
private:
  ...
  static constexpr char *scr_base(void) { return (char *)scr_base_uint; }
