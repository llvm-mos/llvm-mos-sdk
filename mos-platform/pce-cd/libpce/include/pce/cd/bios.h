 ...
 * @param mode The operation mode; @ref pce_cdb_location_type , @ref
 * pce_cdb_base_set_mode
 */
 ...
 * @param length The data length, in sectors unless otherwise specified by the
 * address type.
 *
 * @return uint8_t @ref pce_cdb_error_code
 */
 ...
 *
 * @return uint16_t BIOS version; high eight bits for major, low eight bits for
 * minor.
 */
...
#define PCE_CDB_VDC_BG_SIZE_32_32                                              \
  (PCE_CDB_VDC_BG_WIDTH_32 | PCE_CDB_VDC_BG_HEIGHT_32)
#define PCE_CDB_VDC_BG_SIZE_64_32                                              \
  (PCE_CDB_VDC_BG_WIDTH_64 | PCE_CDB_VDC_BG_HEIGHT_32)
#define PCE_CDB_VDC_BG_SIZE_128_32                                             \
  (PCE_CDB_VDC_BG_WIDTH_128 | PCE_CDB_VDC_BG_HEIGHT_32)
#define PCE_CDB_VDC_BG_SIZE_32_64                                              \
  (PCE_CDB_VDC_BG_WIDTH_32 | PCE_CDB_VDC_BG_HEIGHT_64)
#define PCE_CDB_VDC_BG_SIZE_64_64                                              \
  (PCE_CDB_VDC_BG_WIDTH_64 | PCE_CDB_VDC_BG_HEIGHT_64)
#define PCE_CDB_VDC_BG_SIZE_128_64                                             \
  (PCE_CDB_VDC_BG_WIDTH_128 | PCE_CDB_VDC_BG_HEIGHT_64)
 ...
 *
 * Configure the RAM buffers and size using the remaining pce_cdb_colors
 * methods.
 *
 * @return true Color transfer successfully queued.
 * @return false Ongoing color transfer; wait for the next VBlank, then try
 * again.
 */
