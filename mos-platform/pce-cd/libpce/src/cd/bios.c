...
uint8_t pce_cdb_cd_reset(void) {
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x01) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_cd_read(pce_sector_t sector, uint8_t address_type, uint16_t address, uint16_t length) {
    ...
    *__ax = length;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x03) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_cdda_play(uint8_t start_type, pce_sector_t start, uint8_t end_type, pce_sector_t end, uint8_t mode) {
    ...
    *__dh = end_type | mode;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x06): "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_cdda_search(pce_sector_t sector, uint8_t mode) {
    ...
    *__bh = mode;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x07): "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_cdda_pause(void) {
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x08) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
static uint8_t pce_cdb_cd_status(uint8_t mode) {
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x09) : "=a"(result) : "a"(mode) : "x", "y", "p"
    );
    return result;
}

uint8_t pce_cdb_cd_busy(void) {
    return pce_cdb_cd_status(0);
}

uint8_t pce_cdb_cd_not_ready(void) {
    return pce_cdb_cd_status(1);
}
...
uint8_t pce_cdb_cdda_read_subcode_q(pce_cdb_subq_data_t *buffer) {
    *__bx = (uint16_t) buffer;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x0A) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
static uint8_t pce_cdb_cd_read_toc(pce_cdb_toc_data_t *buffer, uint8_t type) {
    ...
    *__al = type;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x0B) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_cd_scan(void) {
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x0C) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
bool pce_cdb_cd_read_subcode_bits(uint8_t *buffer) {
    ...
    bool result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x0D) : "=a"(value), "=c"(result) : : "x", "y", "p"
    );
    *buffer = value;
    return !result;
}
...
uint16_t pce_cdb_cdda_read_sample(uint8_t channel) {
    uint8_t x, y;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x0E) : "=x"(x), "=y"(y) : "a"(channel) : "a", "p"
    );
    return (y << 8) | x;
}
...
void pce_cdb_fader(uint8_t mode) {
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x0F) : "=a"(mode) : : "x", "y", "p"
    );
}

void pce_cdb_adpcm_reset(void) {
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x10) : : : "a", "x", "y", "p"
    );
}
...
uint8_t pce_cdb_adpcm_read_from_cd(pce_sector_t sector, uint8_t length, uint16_t address) {
    ...
    *__bx = address;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x11) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_adpcm_write_to_ram(uint16_t source, uint8_t dest_type, uint16_t dest, uint16_t length) {
    ...
    *__ax = length;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x12) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_adpcm_read_from_ram(uint8_t source_type, uint16_t source, uint16_t dest, uint16_t length) {
    ...
    *__ax = length;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x13) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_adpcm_play(uint16_t address, uint16_t length, uint8_t divider, uint8_t mode) {
    ...
    *__dl = mode & 0xFE;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x14) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
uint8_t pce_cdb_adpcm_stream(pce_sector_t sector, pce_sector_t length, uint8_t divider) {
    ...
    *__dh = divider;
    uint8_t result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x15) : "=a"(result) : : "x", "y", "p"
    );
    return result;
}
...
void pce_cdb_irq_set(uint8_t type, void (*irq_handler)(void)) {
    ...
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x1F) : : "a"(type), "x"(x), "y"(y) : "a", "x", "y", "p"
    );
}
...
void pce_cdb_vdc_bg_set_size(uint8_t size) {
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x23) : : "a"(size) : "a", "x", "y", "p"
    );
}
...
bool pce_cdb_vdc_set_resolution(uint8_t clock, uint8_t width_tiles, uint8_t height_tiles) {
    bool result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x25) : "=c"(result) : "a"(clock), "x"(width_tiles), "y"(height_tiles) : "a", "x", "y", "p"
    );
    return !result;
}
...
void pce_cdb_vdc_irq_scanline_set(uint16_t line) {
    ...
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x38) : : "a"(a), "x"(x) : "a", "x", "y", "p"
    );
}
...
uint8_t pce_cdb_bin_to_bcd(uint8_t value) {
    ...
    bool result_flag;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x3C) : "=a"(result_value), "=c"(result_flag) : : "x", "y", "p"
    );
...
uint8_t pce_cdb_bcd_to_bin(uint8_t value) {
    ...
    bool result_flag;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x3D) : "=a"(result_value), "=c"(result_flag) : : "x", "y", "p"
    );
    return result_flag ? 0xFF : result_value;
} 
...
bool pce_cdb_ram_query(uint8_t *bank_start, uint8_t *bank_size) {
    ...
    bool result;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x4A) : "=c"(result), "=a"(start), "=x"(size) : : "y", "p"
    );
    if (bank_start != NULL)
        *bank_start = start;
    if (bank_size != NULL)
...
static bool pce_cdb_colors_cmd(uint8_t cmd) {
    ...
    *__color_cmd = cmd;
    __attribute__((leaf)) asm volatile(
        ASM_BIOSCALL(0x4C) : : : "a", "x", "y", "p"
    );
    return true;
}

bool pce_cdb_colors_read(void) {
    return pce_cdb_colors_cmd(0x01);
}

bool pce_cdb_colors_set(void) {
    return pce_cdb_colors_cmd(0x02);
}
