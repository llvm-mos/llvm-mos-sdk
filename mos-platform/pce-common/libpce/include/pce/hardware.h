...
#define VDC_TIMING(offset, width)                                              \
  (VDC_TIMING_OFFSET(offset) | VDC_TIMING_WIDTH(width))
...
#define VPC_PRIORITY_DEFAULT(window)                                           \
  (0x0 << (window)) /* -> SP2 BG -> BG2 -> SP2 FG -> SP1 BG -> BG1 -> SP1 FG   \
                     */
