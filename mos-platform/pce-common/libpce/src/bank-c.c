...
__attribute__((leaf)) uint8_t pce_bank0_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #1" : "=a"(result) : :);
  return result;
}

void pce_bank0_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #1" : "+a"(id) : :);
}
...
__attribute__((leaf)) uint8_t pce_bank1_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #2" : "=a"(result) : :);
  return result;
}

void pce_bank1_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #2" : "+a"(id) : :);
}
...
__attribute__((leaf)) uint8_t pce_bank2_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #4" : "=a"(result) : :);
  return result;
}

void pce_bank2_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #4" : "+a"(id) : :);
}
...
__attribute__((leaf)) uint8_t pce_bank3_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #8" : "=a"(result) : :);
  return result;
}

void pce_bank3_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #8" : "+a"(id) : :);
}
...
__attribute__((leaf)) uint8_t pce_bank4_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #16" : "=a"(result) : :);
  return result;
}

void pce_bank4_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #16" : "+a"(id) : :);
}
...
__attribute__((leaf)) uint8_t pce_bank5_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #32" : "=a"(result) : :);
  return result;
}

void pce_bank5_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #32" : "+a"(id) : :);
}
...
__attribute__((leaf)) uint8_t pce_bank6_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #64" : "=a"(result) : :);
  return result;
}

void pce_bank6_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #64" : "+a"(id) : :);
}
...
__attribute__((leaf)) uint8_t pce_bank7_get(void) {
  uint8_t result;
  __attribute__((leaf)) asm volatile("tma #128" : "=a"(result) : :);
  return result;
}

void pce_bank7_set(uint8_t id) {
  __attribute__((leaf)) asm volatile("tam #128" : "+a"(id) : :);
}
