...
void pce_bank0i_set(uint8_t id) __attribute__((alias ("pce_bank0_set")));
...
void pce_bank1i_set(uint8_t id) __attribute__((alias ("pce_bank1_set")));
...
void pce_bank2i_set(uint8_t id) __attribute__((alias ("pce_bank2_set")));
...
void pce_bank7i_set(uint8_t id) __attribute__((alias ("pce_bank7_set")));
