...
void pce_vdc_bg_enable(void) {
    pce_vdc_enable(VDC_CONTROL_ENABLE_BG);
}

void pce_vdc_bg_disable(void) {
    pce_vdc_disable(VDC_CONTROL_ENABLE_BG);
}

void pce_vdc_sprite_enable(void) {
    pce_vdc_enable(VDC_CONTROL_ENABLE_SPRITE);
}
...
void pce_vdc_irq_vblank_enable(void) {
    pce_vdc_enable(VDC_CONTROL_IRQ_VBLANK);
}
