...
printf("__rom_0_offset = 0xe000;")
printf("__rom_0_size = 0x2000;")
printf("__rom_0_position = 0;")
for i = 1,BANK_MAX-1 do
	printf("PROVIDE(__rom_%d_offset = 0xc000);", i)
	printf("PROVIDE(__rom_%d_size = 0);", i)
	printf("__rom_%d_position = __rom_%d_position + __rom_%d_size;", i, i-1, i-1)
end
...
printf("ASSERT(__rom_end_position <= %d, \"ROM size cannot be larger than %d KB.\");", BANK_MAX*BANK_KB*1024, BANK_MAX*BANK_KB)
