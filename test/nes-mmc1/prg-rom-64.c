...
__attribute__((section(".prg_rom_2.rodata"))) volatile const char e[15000] = {
    5, [14999] = 6};
...
__attribute__((noinline, section(".prg_rom_2.text"))) char bank_2_fn(void) {
  asm volatile("");
  return 8;
}
...
int main(void) {
  ...
  set_prg_bank(2);
  if ((unsigned)bank_2_fn >= 0xc000 || bank_2_fn() != 8)
    return EXIT_FAILURE;
