...
__attribute__((section(".prg_rom_30.rodata"))) volatile const char e[15000] = {
    5, [14999] = 6};
...
__attribute__((noinline, section(".prg_rom_30.text"))) char bank_30_fn(void) {
  asm volatile("");
  return 8;
}
...
int main(void) {
  ...
  set_prg_bank(30);
  if ((unsigned)bank_30_fn >= 0xc000 || bank_30_fn() != 8)
    return EXIT_FAILURE;
